            ...
            for row in csv_reader:
                if row[0] != "":
                    water_model.objects.create(
                        water_longitude=row[1], water_latitude=row[2]
                    )
            ...
            for row in csv_reader:
                if row[0] != "":
                    wifi_model.objects.create(
                        wifi_longitude=row[1], wifi_latitude=row[2]
                    )
            ...
            for row in csv_reader:
                if row[0] != "":
                    parking_model.objects.create(
                        parking_longitude=row[1], parking_latitude=row[2]
                    )
            ...
            for row in csv_reader:
                if row[0] != "":
                    bench_model.objects.create(
                        bench_longitude=row[1], bench_latitude=row[2]
                    )
            ...
            for row in csv_reader:
                if row[0] != "":
                    toilet_model.objects.create(
                        toilet_longitude=row[1], toilet_latitude=row[2]
                    )
