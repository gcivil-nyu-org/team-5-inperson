...
class water_model(models.Model):
    ...
    def __str__(self):
        return self.name+"_lng_"+str(self.water_longitude)+"_lat_"+str(self.water_latitude)
...
class toilet_model(models.Model):
    ...
    def __str__(self):
        return self.name+"_lng_"+str(self.toilet_longitude)+"_lat_"+str(self.toilet_latitude)
...
class wifi_model(models.Model):
    ...
    def __str__(self):
        return self.name+"_lng_"+str(self.wifi_longitude)+"_lat_"+str(self.wifi_latitude)
...
class parking_model(models.Model):
    ...
    def __str__(self):
        return self.name+"_lng_"+str(self.parking_longitude)+"_lat_"+str(self.parking_latitude)
...
class bench_model(models.Model):
    ...
    def __str__(self):
        return self.name+"_lng_"+str(self.bench_longitude)+"_lat_"+str(self.bench_latitude)
