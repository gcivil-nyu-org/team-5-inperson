...
ALLOWED_HOSTS = [
    ...
    "nycbasics5prod.ml",
    "rds-Suyash-env.eba-x9nyundr.us-west-2.elasticbeanstalk.com",
]
...
CORS_ORIGIN_WHITELIST = [
    ...
    "http://rds-Suyash-env.eba-x9nyundr.us-west-2.elasticbeanstalk.com",
    "https://rds-Suyash-env.eba-x9nyundr.us-west-2.elasticbeanstalk.com",
]
